   ...
   <div id="main-wrapper" data-navbarbg="skin6" data-theme="light" data-layout="vertical" data-sidebartype="full" data-boxed-layout="full">
      ...
      <div class="page-wrapper">
         ...
         <div class="container-fluid">
            ...
            <!-- Start Page Content -->
            <form class="form-horizontal form-material" action="<?= URL . 'equipos/insertar' ?>" method="post" enctype="multipart/form-data">
               <div class="row">
                  <!-- Column -->
                     ...
                     <div class="card">
                        <div class="card-body">
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-md-12">
                                 <textarea rows="5" class="form-control form-control-line" name="equipo-descripcion" id="equipo-descripcion"></textarea>
                              </div>
                           </div>
                           <div class="form-group">
                              <div class="col-sm-12">
