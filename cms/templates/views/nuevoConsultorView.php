            ...
            <form class="form-horizontal form-material" action="<?= URL . 'consultores/insertar' ?>" method="post" enctype="multipart/form-data">
               <div class="row">
                  ...
                  <div class="col-lg-4 col-xlg-3 col-md-5">
                     <div class="card">
                        <div class="card-body">
                           <center class="m-t-30"> <img src="<?= IMAGES . 'consultores/default_logo.png' ?>" class="rounded-circle img-preview" width="150" />
                     ...
                     <div class="card">
                        <div class="card-body">
                           <div class="form-group">
                              ...
                              <div class="col-md-12">
                                 <input type="text" class="form-control form-control-line" name="consultor-nombre" id="consultor-nombre" required>
                              </div>
                           </div>
                           <div class="form-group">
                              <div class="col-sm-12">
