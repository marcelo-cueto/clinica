            ...
            <form class="form-horizontal form-material" action="<?= URL . 'consultores/insertar' ?>" method="post" enctype="multipart/form-data">
               <div class="row">
                  ...
                  <div class="col-lg-4 col-xlg-3 col-md-5">
                     <div class="card">
                        <div class="card-body">
                           <center class="m-t-30"> <img src="<?= isset($data['consultores']->img_logo) ? IMAGES . 'consultores/' . $data['consultores']->img_logo : IMAGES . 'consultores/default_logo.png' ?>" class="rounded-circle" width="150" />
                              <div class="row text-center justify-content-md-center mt-2">
                                 <div class="form-group">
                                    <label class="col-md-12">Imagen Logo (.png/.jpg/.bmp)</label>
                                    <div class="col-md-12">
                                       <input type="file" class="form-control" name="consultor-img" id="consultor-img">
                                    </div>
                                 </div>
                              </div>
                           </center>
